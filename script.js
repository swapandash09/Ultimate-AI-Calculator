...
function addBmItem() {
  ...
  // Carry MRP through proportionally too (e.g. matched a "1kg MRP ₹150"
  // item and billing 500g → MRP shown should be ₹75, not the full ₹150).
  let mrp = 0;
  if (bmMatchedCatalogItem && bmMatchedCatalogItem.mrp > 0) {
